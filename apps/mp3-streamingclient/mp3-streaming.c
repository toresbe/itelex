...
void mp3client_stream( void )
{
	...
	if( CheckSocketState( MP3_SOCKET ) != SOCKET_READY )
	{
		MP3_SOCKET = SOCKET_ERROR;
	}
	else
 ...
 */
/*------------------------------------------------------------------------------------------------------------*/
void mp3client_startstreaming( char * streamingPROTO, char * streamingURL, long streamingIP, int streamingPORT, char * streamingFILE, int socket )
{
