...
{	
	DOGL128_PORT.DIRSET = ( 1<<DOGL128_A0_PIN ) | ( 1<<DOGL128_SI_PIN ) | ( 1<<DOGL128_SCL_PIN ) | ( 1<<DOGL128_RESET_PIN ) | ( 1<<DOGL128_CS_PIN );
	DOGL128_PORT.OUTCLR = ( 1<<DOGL128_A0_PIN ) | ( 1<<DOGL128_SI_PIN ) | ( 1<<DOGL128_SCL_PIN ) | ( 1<<DOGL128_RESET_PIN ) | ( 1<<DOGL128_CS_PIN );
	_delay_ms( 10 );
