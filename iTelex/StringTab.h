...
_STRTABENTRY(NamensucheTexteingabe, "teilnehmersuche nach:     ", "search subscribers for:     ")
_STRTABENTRY(NamensucheZuKurz, "\r\nmindestens 3 zeichen eingeben.    \r\n", "\r\nenter at least three characters.    \r\n")
_STRTABENTRY(NamensucheNurLokal, "\r\nkeine verbindung zum teilnehmer-server. lokal vorhandene eintraege:", "\r\nno connection to subscriber server. locally stored entries:")
_STRTABENTRY(NamensucheErgebnisse, "\r\nnummer / name / verbindung:\r\n", "\r\nnumber / name / connection:\r\n")
