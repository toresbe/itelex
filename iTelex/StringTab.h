...
_STRTABENTRY(AlternativSucheBeiBesetzt, "Weiterleitung bei besetzt", "Forward calls to alternative teleprinter if called is busy")
_STRTABENTRY(ASBB_Niemals, "nie", "never")
_STRTABENTRY(ASBB_NurHauptstelle, "nur bei Hauptstelle", "only calls to primary printer")
